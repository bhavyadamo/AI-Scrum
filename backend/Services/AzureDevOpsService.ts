...
export class AzureDevOpsService {
  ...
  constructor(organization = 'inatech', project?: string) {
...
async function example() {
  try {
    const azureDevOpsService = new AzureDevOpsService('inatech', 'YourProjectName');
    
    // Query work items by iteration path and date range
